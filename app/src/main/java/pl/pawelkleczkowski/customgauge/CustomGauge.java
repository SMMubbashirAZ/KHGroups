...
public class CustomGauge extends View {
	...
	public CustomGauge(Context context, AttributeSet attrs) {
		...
		mStrokeColor = a.getColor(R.styleable.CustomGauge_strokeColor, Color.BLUE);
		...
		mEndValue = a.getInt(R.styleable.CustomGauge_endValue, 200);
		
		// pointer size and color
		mPointSize = a.getColor(R.styleable.CustomGauge_pointSize, 0);
		mPointStartColor = a.getColor(R.styleable.CustomGauge_pointStartColor, Color.WHITE);
		mPointEndColor = a.getColor(R.styleable.CustomGauge_pointEndColor, Color.WHITE);
	...
	public void setValue(double value) {
		//mValue = Integer.parseInt(String.valueOf(value)) ;
		mValue = value ;
