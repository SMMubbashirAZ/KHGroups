...
public class SwipeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.custom_row_swipe, parent, false);
            item = new ViewHolder();
            item.item_left = convertView.findViewById(R.id.item_left);
            item.item_right = convertView.findViewById(R.id.item_right);
            item.item_left_txt = convertView.findViewById(R.id.item_left_txt);
            item.item_right_txt = convertView.findViewById(R.id.item_right_txt);
