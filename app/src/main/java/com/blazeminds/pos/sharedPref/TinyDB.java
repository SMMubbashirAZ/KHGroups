...
public class TinyDB {
    ...
    public ArrayList<MainCartModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MainCartModel> playerList =  new ArrayList<MainCartModel>();

        for(String jObjString : objStrings){
            MainCartModel player  = gson.fromJson(jObjString,  MainCartModel.class);
    ...
    public void putListObject(String key, ArrayList<MainCartModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MainCartModel player: playerList){
