...
public class ListViewAdapterDailyExpenseDetails extends BaseAdapter {

    public JSONArray list;
    Activity activity;

    public ListViewAdapterDailyExpenseDetails(Context activity, JSONArray list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        ListViewAdapterDailyExpenseDetails.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.input_daily_expense, null);
            holder = new ListViewAdapterDailyExpenseDetails.ViewHolder();
...
*/
            ...
            holder = (ListViewAdapterDailyExpenseDetails.ViewHolder) convertView.getTag();
        }
