...
public class ListViewAdapter3rowqty2 extends BaseAdapter {
    
    public ArrayList<HashMap<String, String>> list;
    Activity activity;
    PosDB db;

    public ListViewAdapter3rowqty2(Context activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ListViewAdapter3rowqty2.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();
        
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listitem_3_row_qty, null);
            holder = new ListViewAdapter3rowqty2.ViewHolder();
           ...
           holder.verifyStock_LV.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   final ListViewAdapter2row arrayAdapter = new ListViewAdapter2row(activity, db.getPatientOrderList_By_OrderID2(txt));
...
*/
            ...
            holder = (ListViewAdapter3rowqty2.ViewHolder) convertView.getTag();
        }
        ...
        try {
            ...
            holder.txtSecond.setText(map.get(REPORT_FOURTH_COLUMN).toString());
