...
public class ListViewAdapter6row extends BaseAdapter {
    
    public ArrayList<HashMap<String, String>> list;
    Activity activity;
    
    public ListViewAdapter6row(Context activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ListViewAdapter6row.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();
        
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listitem_6_row, null);
            holder = new ListViewAdapter6row.ViewHolder();
            ...
            holder.txtFifth = convertView.findViewById(R.id.Fifth);
            holder.txtSixth = convertView.findViewById(R.id.Sixth);
/*
...
*/
            ...
            holder = (ListViewAdapter6row.ViewHolder) convertView.getTag();
        }
        ...
        try {
            ...
            holder.txtFifth.setText(map.get(REPORT_FIFTH_COLUMN).toString());
            holder.txtSixth.setText(map.get(REPORT_SIXTH_COLUMN).toString());
