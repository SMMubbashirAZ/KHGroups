...
public class MonthlyTargetHeaderAdapter extends BaseAdapter {
    
    public ArrayList<HashMap<String, String>> list;
    Activity activity;
    
    public MonthlyTargetHeaderAdapter(Context activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        MonthlyTargetHeaderAdapter.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();
        
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listitem_4_target_header, null);
            holder = new MonthlyTargetHeaderAdapter.ViewHolder();
...
*/
            ...
            holder = (MonthlyTargetHeaderAdapter.ViewHolder) convertView.getTag();
        }
        ...
        try {
            ...
            System.out.println("Error Monthly Target Header Adapter: " + e.toString());
        }
        return convertView;
