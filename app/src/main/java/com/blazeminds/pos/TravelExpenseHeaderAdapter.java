...
public class TravelExpenseHeaderAdapter extends BaseAdapter {
    
    public ArrayList<HashMap<String, String>> list;
    Activity activity;
    
    public TravelExpenseHeaderAdapter(Context activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        final TravelExpenseHeaderAdapter.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();
        
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listitem_4_travel_exp_header, null);
            holder = new TravelExpenseHeaderAdapter.ViewHolder();
            ...
            holder = (TravelExpenseHeaderAdapter.ViewHolder) convertView.getTag();
        }
        ...
        try {
            ...
            holder.fromTownTV.setText(map.get("t_exp_from_town").toString());
            holder.toTownTV.setText(map.get("t_exp_to_town").toString());
            holder.dateTV.setText(map.get("t_exp_datetime").toString());
            ...
            System.out.println("Error Travel Expense HEADER Adapter: " + e.toString());
        }
        return convertView;
    }
