...
public class ListViewAdapter5row extends BaseAdapter {
    
    public ArrayList<HashMap<String, String>> list;
    Activity activity;
    
    public ListViewAdapter5row(Context activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ListViewAdapter5row.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();
        
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listitem_5_row, null);
            holder = new ListViewAdapter5row.ViewHolder();
...
*/
            ...
            holder = (ListViewAdapter5row.ViewHolder) convertView.getTag();
        }
