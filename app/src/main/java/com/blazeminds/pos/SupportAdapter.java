...
public class SupportAdapter extends BaseAdapter {
    ...
    public SupportAdapter(Activity activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        final SupportAdapter.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();
        
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listitem_4_support, null);
            holder = new SupportAdapter.ViewHolder();
            ...
            holder.titleTV = convertView.findViewById(R.id.titleTxt);
            holder.statusTV = convertView.findViewById(R.id.statusTxt);
            ...
            holder = (SupportAdapter.ViewHolder) convertView.getTag();
        }
        ...
        try {
            ...
            holder.dateTV.setText(convertDate(map.get("support_datetime").toString()));
            holder.titleTV.setText(map.get("support_id").toString() + " | " + map.get("support_title").toString());
            holder.statusTV.setText(map.get("support_status_name").toString());
            ...
            System.out.println("Error Support List Adapter: " + e.toString());
        }
