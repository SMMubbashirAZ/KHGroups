...
public class ListViewAdapterdsr extends BaseAdapter {

    public ArrayList<HashMap<String, String>> list;
    Activity activity;

    public ListViewAdapterdsr(Context activity, ArrayList<HashMap<String, String>> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ListViewAdapterdsr.ViewHolder holder;
        LayoutInflater inflater = activity.getLayoutInflater();

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listitem_5_rowdsr, null);
            holder = new ListViewAdapterdsr.ViewHolder();
...
*/
            ...
            holder = (ListViewAdapterdsr.ViewHolder) convertView.getTag();
        }
