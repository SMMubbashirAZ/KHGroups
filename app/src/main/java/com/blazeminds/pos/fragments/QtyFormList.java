...
public class QtyFormList extends Fragment {

	public final static String TAG = QtyFormList.class.getSimpleName();
ListView PatientListView;
	...
	public static QtyFormList newInstance() {
		return new QtyFormList();
	}
