...
public class UnProductiveFragment extends Fragment implements MyListener {

    public final static String TAG = UnProductiveFragment.class.getSimpleName();
    ...
    public UnProductiveFragment() {
    }

    public static UnProductiveFragment newInstance() {
        return new UnProductiveFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_un_productive, container, false);
        initUI(rootView);
        return rootView;
    }
...
//        headerListView = rootView.findViewById(R.id.headerListView);
        ...
        recyclerView = rootView.findViewById(R.id.un_prod_rv);
...
//        headerListView.setAdapter(adapter1);
    ...
    private ArrayList<HashMap<String, String>> populateList(TextView noItemText) {
        ...
        if (savedRoute == 0) {
            ...
            data = db.getCustomerListForRoutePlan( UserSettings.UN_PRODUCTIVE);
        } else {
            dataCustId = db.getSelectedCustomerIDByRoute(savedRoute);
            data = db.getCustomerListForRoutePlanByRoute(savedRoute, UserSettings.UN_PRODUCTIVE);
