...
import com.blazeminds.pos.adapter.ListViewAdapter3rowqty2;
...
public class QtyFormList2 extends Fragment {

	public final static String TAG = QtyFormList2.class.getSimpleName();
ListView PatientListView;
	...
	public static QtyFormList2 newInstance() {
		return new QtyFormList2();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		db.OpenDb();
		View rootView = inflater.inflate(R.layout.fragment_place_order_list2, container, false);
		...
		final ListViewAdapter3rowqty2 PatientListAdapter= new ListViewAdapter3rowqty2(getActivity(),db.getPatientOrderList2());
