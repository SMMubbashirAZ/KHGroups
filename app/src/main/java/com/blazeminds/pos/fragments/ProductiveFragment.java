...
public class ProductiveFragment extends Fragment implements MyListener {
    public final static String TAG = ProductiveFragment.class.getSimpleName();
    ...
    private Context c;
    public ProductiveFragment() {
    }

    public static ProductiveFragment newInstance() {
...
//        headerListView = rootView.findViewById(R.id.headerListView);
        ...
        recyclerView = rootView.findViewById(R.id.prod_rv);
...
//        headerListView.setAdapter(adapter1);
    ...
    private ArrayList<HashMap<String, String>> populateList(TextView noItemText) {
        ...
        if (savedRoute == 0) {
            ...
            data = db.getCustomerListForRoutePlan( UserSettings.PRODUCTIVE);
        } else {
            dataCustId = db.getSelectedCustomerIDByRoute(savedRoute);
            data = db.getCustomerListForRoutePlanByRoute(savedRoute, UserSettings.PRODUCTIVE);
